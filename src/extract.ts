...
function extractK6Result(output: string): BenchmarkResult[] {
    try {
        ...
        throw new Error(
            `Output file for 'k6' must be JSON file generated by --benchmark-json option: ${err.message}`,
        );
    }    
}
